                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-11">
                                            <div class="container-fluid">
                                                ...
                                                <form method="POST" action="<?php echo base_url();?>business/update/<?php echo $data_list[0]['sno_user'] ?>" id="frm_user">
                                                        <div class="box-body">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div>
                                                                <div class="col-md-6">
                                                                    <input type="text" name="first_name" class="form-control" id="first_name" value="<?php echo $data_list[0]['firstname'] ?>" required="required">
                                                                </div>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="email" name="email" class="form-control" id="email" value="<?php echo $data_list[0]['email'] ?>" required="required">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="bdc_license">Create Password</label>
                                                                <input type="password" name="password" class="form-control" id="password" value="<?php echo $data_list[0]['password'] ?>" required="required">
                                                            </div>
                                                            <div class="form-group col-md-12">
